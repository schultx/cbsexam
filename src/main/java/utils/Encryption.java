...
public final class Encryption {
  ...
  public static String encryptDecryptXOR(String rawString) {
    ...
    if (Config.getEncryption()) {
      ...
      // TODO: This is where the magic of XOR is happening. Are you able to explain what is going on? mangler beskrivelse
      // Dette er forklaret dybbere i rapporten, men kort sagt så går den ind
